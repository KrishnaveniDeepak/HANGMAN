...
class HangmanApp:
    def __init__(self, master):  
        ...
        self.attempts_label = tk.Label(master, text="Attempts left: " + str(self.attempts), font=("Helvetica", 16))
    ...
    def process_guess(self):
        ...
        if "_" not in self.display_word():
            self.score += 10
            self.master.after(100, self.congratulate_player)  # Allowing a small delay to update display
